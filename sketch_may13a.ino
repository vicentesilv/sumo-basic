...
int sensorDelantero= 2; //sensor ir en A1
int lecturaDelantera=0; //lectura del sensor trasero
int Delantero=0;        //delantero

int sensorTrasero= 13; //sensor ir en A0
int lecturaTrasera=0; //lectura del sensor trasero
int Trasero=0;        //trasero

int pecho = A3;            // define el pin 2 como (pecho) para el Ultrasonido
int ptrig = A2;            // define el pin 3 como (ptrig) para el Ultrasonido
